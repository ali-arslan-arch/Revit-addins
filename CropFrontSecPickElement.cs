...
namespace MyRevitCommands
{
    ...
    internal class CropFrontSecPickElement : IExternalCommand
    {
        ...
        /*public static double GetWidth(Element ele)
        {
            FamilyInstance fi = ele as FamilyInstance;
            FamilySymbol fs = fi.Symbol;
            Parameter width = fi.get_Parameter(BuiltInParameter.FAMILY_WIDTH_PARAM);
            if (width == null) 
            {
                width = fs.get_Parameter(BuiltInParameter.FAMILY_WIDTH_PARAM);
            }
            return width.AsDouble();
